                      ...
                      <div class="image-upload">
                        ...
                        <div class="p-3">
                          <div class="d-flex align-items-center">
                            <button class="btn btn_upload m-1 text-white mt-3" style="background-color: #5BBB7B !important;" @click="uploadImage">Upload</button>
                            <button class="btn btn_upload  m-1 text-white mt-3" style="border-color: red; color: red !important;" @click="">Delete</button>
                          </div>
                          <p style="max-width: 300px;" class="">image must be png, jpg, jpeg formate. Height and weight must be
                            <spna class="text-danger">200x200</spna>.</p>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="text-start d-flex align-items-center">
                              <button type="submit"  id="skills-tab" data-bs-toggle="tab" data-bs-target="#skills" role="tab" aria-controls="skills" aria-selected="false" class="ud-btn btn-thm">Save </button>
                              <button type="button"  id="skills-tab" data-bs-toggle="tab" data-bs-target="#skills" role="tab" aria-controls="skills" aria-selected="false" class="ud-btn btn-thm ms-2">Save & next </button>
                            </div>
                          </div>
                        </div>
                      </form>
                      ...
                      <div class="ps-widget bgc-white bdrs4 p1 mb30 overflow-hidden position-relative">
                        <div class="bdrb1 pb15 mb25">
                          ...
                          <ul class="d-flex flex-wrap align-items-center p-0 mt-3">
                            <li class="badge bg-primary  me-2 my-2"  v-for="(skill, index) in skillsdata" :key="skill.id">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="text-start d-flex align-items-center">
                              <button type="submit"  @click="submitskills" id="skills-tab" data-bs-toggle="tab" data-bs-target="#skills" role="tab" aria-controls="skills" aria-selected="false" class="ud-btn btn-thm">Save </button>
                              <button type="button"  id="skills-tab" data-bs-toggle="tab" data-bs-target="#education" role="tab" aria-controls="skills" aria-selected="false" class="ud-btn btn-thm ms-2">Save & next </button>
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div v-for="edu in euddata" :key="edu.id" class="wrapper mb40 position-relative">
                              <div class="del-edit">
                                <div class="d-flex">
                                  ...
                                  <a href="#" class=" p-2 text-danger rounded-2 d-flex jastify-content-center align-items-center" style="border-color: red; border: 1px solid;" data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                    @click.prevent="removeEducation(edu.id)" data-bs-original-title="Delete"
                                    aria-label="Delete"><span class="flaticon-delete m-0"></span></a>
                                </div>
                              </div>
                      ...
                      <div class="ps-widget bgc-white bdrs4 p1 mb30 overflow-hidden position-relative">
                        ...
                        <div class="position-relative">
                          <div class="educational-quality__">
                            ...
                            data-bs-original-title="Edit" aria-label="Edit"><span class="flaticon-pencil"></span></a> -->
                                  <a href="javascript:void(0);"  class=" p-2 text-danger rounded-2 d-flex jastify-content-center align-items-center" style="border-color: red; border: 1px solid;" data-bs-toggle="tooltip"
